...
********************************************************************************
	...
	local 		titles 		"ytitle(Percentage of Annual Occurence) note("Coffee sales source: Yomol A'Tel 2013 - 2019 receipts." "Honey sales receipts: Yomol A'Tel 2022 receipts.")" 		
...
//	reshape 	wide food_insecurity  honey_mean coffee_mean , i(month) j(type )
	...
	statsby 	food_insecurity1=r(mu_2) food_insecurity2=r(mu_1) t=r(t), by(month) clear: ttest food_insecurity, by(honey_producer)
